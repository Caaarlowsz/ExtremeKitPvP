...
public class Menus implements Listener {
	...
	public static void guiKits(Player p) {
		...
		warpv11.setDisplayName("§dPRIMARY");
		...
		warpv111.setDisplayName("§6INTERMEADIARY");
		...
		warpv1111.setDisplayName("§cADVANCED");
		...
		warp22v.setDisplayName("§8BRONZE");
		...
		warp23v.setDisplayName("§7SILVER");
		...
		warp2v.setDisplayName("§bDIAMOND");
		...
		warp26v.setDisplayName("§2LEGENDARY");
