...
/*     */ 
/*     */ 
/*  28 */     ItemStack vidro = im.createItem(Material.STAINED_GLASS_PANE, "vidro", "-", new String[0], 1, (short)11);
/*  29 */     ItemStack vermelho = im.createItem(Material.THIN_GLASS, "vidro", "-", new String[0], 1, (short)11);
/*  30 */     ItemStack verde = im.createItem(Material.THIN_GLASS, "vidro", "-", new String[0], 1, (short)11);
...
/* 291 */     ItemStack fogo = im.createItem(Material.getMaterial(51), "vidro", "§6§ManoKakashi", new String[0], 1, (short)0);
