...
/*  25 */     if (p.getOpenInventory().getTitle().equalsIgnoreCase("§b§lYoutuber §bKITPVP")) {
...
/*     */   {
/*  33 */     ItemStack vidro = im.createItem(Material.getMaterial(102), "vidro", "-", new String[0], 1, (short)11);
...
/*     */     
/*     */ 
/*  39 */     Inventory inv = Bukkit.createInventory(p, 9, "§b§lYoutuber §bKITPVP");
/*     */     
...
/*     */   {
/*  54 */     ItemStack vidro = im.createItem(Material.getMaterial(102), "vidro", "-", new String[0], 1, (short)11);
...
/*     */     
/*  57 */     Inventory inv = Bukkit.createInventory(p, 27, "§bServidor §bKITPVP");
/*     */     
...
/*     */   {
/*  72 */     ItemStack vidro = im.createItem(Material.getMaterial(102), "vidro", "-", new String[0], 1, (short)11);
/*  73 */     Inventory inv = Bukkit.createInventory(p, 27, "§bWarps §bKITPVP");
/*  74 */     ItemStack fps = im.createItem(Material.getMaterial(20), "fps", "§bFPS", new String[0], 1, (short)0);
/*  75 */     ItemStack challenge = im.createItem(Material.getMaterial(327), "challenge", "§bChallenge", new String[0], 1, (short)0);
/*  76 */     ItemStack rdm = im.createItem(Material.getMaterial(354), "rdm", "§bRDM", new String[0], 1, (short)0);
/*  77 */     ItemStack fulliron = im.createItem(Material.getMaterial(369), "1v1", "§b1v1", new String[0], 1, (short)0);
/*  78 */     ItemStack mdr = im.createItem(Material.getMaterial(35), "mdr", "§bMDR", new String[0], 1, (short)0);
/*     */     
...
/*  99 */     if ((p.getOpenInventory().getTitle().equalsIgnoreCase("§bWarps §bKITPVP")) || (p.getOpenInventory().getTitle().equalsIgnoreCase("§bServidor §bKITPVP"))) {
/* 100 */       event.setCancelled(true);
/* 101 */       p.updateInventory();
/*     */       
/* 103 */       if (event.getCurrentItem().getItemMeta().getDisplayName().equals("§bFPS"))
/*     */       {
/* 105 */         p.chat("/fps");
/* 106 */         p.closeInventory();
/*     */       }
/*     */       
/* 109 */       if (event.getCurrentItem().getItemMeta().getDisplayName().equals("§bChallenge"))
/*     */       {
/* 111 */         p.chat("/challenge");
/* 112 */         p.closeInventory();
/*     */       }
/*     */       
/* 115 */       if (event.getCurrentItem().getItemMeta().getDisplayName().equals("§bRDM"))
/*     */       {
/* 117 */         p.chat("/rdm");
/* 118 */         p.closeInventory();
/*     */       }
/*     */       
/* 121 */       if (event.getCurrentItem().getItemMeta().getDisplayName().equals("§b1v1"))
/*     */       {
/* 123 */         p.chat("/1v1");
...
/*     */       }
/*     */       
/* 127 */       if (event.getCurrentItem().getItemMeta().getDisplayName().equals("§bMDR"))
/*     */       {
/* 129 */         p.chat("/mdr");
