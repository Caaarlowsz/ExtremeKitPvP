...
/*    */   {
/* 28 */     if ((label.equalsIgnoreCase("crash")) && (sender.hasPermission("kitpvp.crash"))) {
/* 29 */       if (args.length < 1) {
...
/* 37 */         return true;
/*    */       }
/* 39 */       sender.sendMessage("ß8[ß6ßlRKß8] Preparando para crashar o jogador " + ChatColor.GOLD + other.getName() + ChatColor.GRAY + "...");
...
/* 44 */           sender.sendMessage("ß8[ß6ßlRKß8] Jogador crashado!");
/*    */         }
/* 46 */       }, 35L);
/*    */     }
/* 48 */     return true;
