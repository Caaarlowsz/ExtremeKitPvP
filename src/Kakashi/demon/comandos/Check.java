...
/* 47 */       (p.hasPermission("kitpvp.check")) && 
/* 48 */       (args.length == 1))
/*    */     {
...
/* 58 */             p.sendMessage("§4§lItem selecionado: §e§l§o" + target.getItemInHand().getType());
/* 59 */             p.sendMessage("§4§lVida: §e§l§o" + (int)hp.getHealth());
/* 60 */             p.sendMessage("§4§lSopas: §e§l§o" + Check.getAmount(target, Material.MUSHROOM_SOUP));
